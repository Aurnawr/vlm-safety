...
def main():
    ...
    os.makedirs(os.path.join(base_dir, "generation_scripts", "pca_plots_no_image_ds1"), exist_ok=True)
    ...
    for layer_idx in range(32):
        ...
        out_file = os.path.join(base_dir, "generation_scripts", "pca_plots_no_image_ds1", f'combined_pca_layer_{layer_to_probe:02d}.png')
    ...
    plt.title('Refusal Vector Cosine Similarity Across Layers (No Image vs Blank Image)')
    plt.xlabel('Layer Number')
    plt.ylabel('Cosine Similarity')
    plt.grid(True)
    
    sim_out_file = os.path.join(base_dir, "generation_scripts", "pca_plots_no_image_ds1", 'cosine_similarity_across_layers.png')
